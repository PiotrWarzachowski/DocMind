  ...
  return (
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        DocMind is a document collaboration tool that brings your documents to life. It allows you to chat with your documents in seconds.
        </p>
        ...
        <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
          <div className="mb-12 px-6 lg:px-8">
              <div className="mx-auto max-w-2xl sm:text-center">
                <h2 className="mt-2 font-bold text-4xl">Start chatting in minutes</h2>
                <p className="mt-4 text-lg text-gray-600">
                  Chatting to your PDF files was never this easy. DocMind allows you to chat with your documents in seconds.
                </p>
              </div>
          </div>
              ...
              <li className="md:flex-1">
                <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                  ...
                  <span className="mt-2 text-zinc-700">
                    Allways free to use. No credit card required.
                  </span>
                </div>
              </li>
              <li className="md:flex-1">
                <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                  ...
                  <span className="mt-2 text-zinc-700">
                    We&apos;ll convert your PDF file to a chat room.
                  </span>
                </div>
              </li>
              <li className="md:flex-1">
