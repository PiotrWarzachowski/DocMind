...
const Dashboard = () => {
    ...
    const [currentlyDeletingFile, setCurrentlyDeletingFile] = useState<string | null>(null); // [fileId, setFileId
    ...
    return (
        <main className="mx-auto max-2-7xl md:p-10">
            ...
            {files && files.length !== 0 ? (
                <ul className="mt-8 grid grid-cols-1 gap-6 divide-y divide-zinc-200 md:grid-cols2 lg:grid-cols-3">
